...
from runners.diffusion_sketch import Diffusion
...
def parse_args_and_config():
    ...
    if not os.path.exists(args.image_folder):
        os.makedirs(args.image_folder+'/y0_mask')
        os.makedirs(args.image_folder+'/degradation')
        os.makedirs(args.image_folder+'/restoration')
        os.makedirs(args.image_folder+'/y_color_correction')
    else:
        overwrite = False
        if args.ni:
            overwrite = True
